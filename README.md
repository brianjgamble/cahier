<p>
    <a href="https://github.com/brianjgamble/cahier/actions/workflows/haskell.yml"><img alt="GitHub Actions Workflow Status" src="https://img.shields.io/github/actions/workflow/status/brianjgamble/cahier/haskell.yml"/></a>
...
Probably not. **_This is not a general purpose website_**. From the design, layout, content, and code, I built this for me.
